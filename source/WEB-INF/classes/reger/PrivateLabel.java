...
public class PrivateLabel {
    ...
    public boolean loadPl(int plid){
        ...
        if (getPl!=null && getPl.length>0){
            ...
            instagramclientid = getPl[0][51];
            instagramclientsecret = getPl[0][52];
            instagramredirecturi = getPl[0][53];
    ...
    public void populateFromRequest(javax.servlet.http.HttpServletRequest request){
        ...
        instagramclientid = reger.core.RequestParam.getString(request, "instagramclientid", "");
        instagramclientsecret = reger.core.RequestParam.getString(request, "instagramclientsecret", "");
        instagramredirecturi = reger.core.RequestParam.getString(request, "instagramredirecturi", "");
