...
public class PrivateLabel {
    ...
    private boolean isgoogleapion = true;
    ...
    public void populateFromRequest(javax.servlet.http.HttpServletRequest request){
        ...
        isgoogleapion = reger.core.RequestParam.getBoolean(request, "isgoogleapion", true);
