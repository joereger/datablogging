...
public class ShadowBox {
    ...
    public static StringBuffer start(String pathtoapproot){
        ...
        mb.append("<tr>");
        mb.append("<td background='"+pathtoapproot+"myhome/images/shadowbox/corner-upper-left.gif' width=26><img src='images/clear.gif' width=26 height=23></td>");
        mb.append("<td background='"+pathtoapproot+"myhome/images/shadowbox/border-top.gif'></td>");
        mb.append("<td background='"+pathtoapproot+"myhome/images/shadowbox/corner-upper-right.gif' width=26><img src='images/clear.gif' width=26 height=23></td>");
        mb.append("</tr>");
        mb.append("<tr>");
    ...
    public static StringBuffer end(String pathtoapproot){
        ...
        mb.append("</tr>");
        mb.append("<tr>");
        mb.append("<td background='"+pathtoapproot+"myhome/images/shadowbox/corner-lower-left.gif'><img src='images/clear.gif' width=26 height=23></td>");
        mb.append("<td background='"+pathtoapproot+"myhome/images/shadowbox/border-bottom.gif'></td>");
        mb.append("<td background='"+pathtoapproot+"myhome/images/shadowbox/corner-lower-right.gif'><img src='images/clear.gif' width=26 height=23></td>");
        mb.append("</tr>");
        mb.append("</table>");
