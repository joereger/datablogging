 ...
 *
 */
public class MarketingHpTemplateTagEntriesMostReadAllTime implements MarketingHpTemplateTag{
    ...
    public String getHtml(UserSession userSession, javax.servlet.http.HttpServletRequest request, PageProps pageProps){
        MarketingSiteTemplateTagEntriesMostReadAllTime tag = new MarketingSiteTemplateTagEntriesMostReadAllTime();
