 ...
 *
 */
public class MarketingHpTemplateTagSitesMostRead implements MarketingHpTemplateTag{
    ...
    public String getHtml(UserSession userSession, javax.servlet.http.HttpServletRequest request, PageProps pageProps){
        MarketingSiteTemplateTagSitesMostRead tag = new MarketingSiteTemplateTagSitesMostRead();
