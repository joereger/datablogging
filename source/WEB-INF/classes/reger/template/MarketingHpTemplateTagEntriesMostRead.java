 ...
 *
 */
public class MarketingHpTemplateTagEntriesMostRead implements MarketingHpTemplateTag{
    ...
    public String getHtml(UserSession userSession, javax.servlet.http.HttpServletRequest request, PageProps pageProps){
        MarketingSiteTemplateTagEntriesMostRead tag = new MarketingSiteTemplateTagEntriesMostRead();
