 ...
 *
 */
public class Version190ToVersion191 implements UpgradeDatabaseOneVersion {

    public void doUpgrade(){

        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("ALTER TABLE account ADD datemarkedinactive datetime default NULL");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int coundt = Db.RunSQLUpdate("UPDATE account SET datemarkedinactive='"+reger.core.TimeUtils.nowInGmtString()+"'");
        //-----------------------------------
        //-----------------------------------
