 ...
 *
 */
public class Version198ToVersion199 implements UpgradeDatabaseOneVersion {
    ...
    public void doUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("ALTER TABLE dropbox ADD logid int(11) NOT NULL default '0'");
        //-----------------------------------
        //-----------------------------------
