 ...
 */
public class Version151ToVersion152 implements UpgradeDatabaseOneVersion{

    public void doUpgrade(){

        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("ALTER TABLE accountuser MODIFY password varchar(255) NOT NULL default ''");
        //-----------------------------------
        //-----------------------------------
