 ...
 */
public class Version155ToVersion156 implements UpgradeDatabaseOneVersion{
    ...
    public void doUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("CREATE TABLE `logtypexform` (`logtypexformid` int(11) NOT NULL auto_increment, eventtypeid int(11), xform longtext, PRIMARY KEY  (`logtypexformid`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("DROP TABLE logxform");
        //-----------------------------------
        //-----------------------------------
