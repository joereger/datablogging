 ...
 *
 */
public class Version196ToVersion197 implements UpgradeDatabaseOneVersion {
    ...
    public void doUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("ALTER TABLE dropbox ADD autoblogpath varchar(1024)");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("UPDATE dropbox SET autoblogpath=''");
        //-----------------------------------
        //-----------------------------------
