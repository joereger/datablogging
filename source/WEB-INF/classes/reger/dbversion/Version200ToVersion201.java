 ...
 *
 */
public class Version200ToVersion201 implements UpgradeDatabaseOneVersion {
    ...
    public void doUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int counta = Db.RunSQLUpdate("ALTER TABLE event ADD ishtml BOOLEAN");
        //-----------------------------------
        //-----------------------------------
        ...
        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("UPDATE event SET ishtml=false");
        //-----------------------------------
        //-----------------------------------
