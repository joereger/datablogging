 ...
 */
public class Version147ToVersion148 implements UpgradeDatabaseOneVersion{

    public void doUpgrade(){

        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("CREATE TABLE `robotstxt` (`robotstxtid` int(11) NOT NULL auto_increment, robotstxt text, PRIMARY KEY  (`robotstxtid`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;");
        //-----------------------------------
        //-----------------------------------
