 ...
 *
 */
public class Version187ToVersion188 implements UpgradeDatabaseOneVersion {
    ...
    public void doUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        String[][] rstEvent= Db.RunSQL("SELECT eventid, locationid FROM event WHERE locationid>'0'");
        //-----------------------------------
        //-----------------------------------
        if (rstEvent!=null && rstEvent.length>0){
            for(int i=0; i<rstEvent.length; i++){
                //-----------------------------------
                //-----------------------------------
                int identity = Db.RunSQLInsert("INSERT INTO locationtoevent(eventid, locationid) VALUES('"+rstEvent[i][0]+"', '"+rstEvent[i][1]+"')");
                //-----------------------------------
                //-----------------------------------
            }
        }
