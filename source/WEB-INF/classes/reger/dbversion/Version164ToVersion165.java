 ...
 */
public class Version164ToVersion165 implements UpgradeDatabaseOneVersion{
    ...
    public void doUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count1 = Db.RunSQLUpdate("ALTER TABLE pl ADD bannerone longtext");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("ALTER TABLE pl ADD bannertwo longtext");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count3 = Db.RunSQLUpdate("ALTER TABLE pl ADD bannerthree longtext");
        //-----------------------------------
        //-----------------------------------
    }
