 ...
 *
 */
public class Version192ToVersion193 implements UpgradeDatabaseOneVersion {
    ...
    public void doUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("ALTER TABLE account ADD aboutthisbloghtml longtext");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int coundt = Db.RunSQLUpdate("UPDATE account SET aboutthisbloghtml=''");
        //-----------------------------------
        //-----------------------------------
        ...
        //-----------------------------------
        //-----------------------------------
        int count3 = Db.RunSQLUpdate("ALTER TABLE account ADD aboutthisblogtitle varchar(255) DEFAULT NULL");
        //-----------------------------------
        //-----------------------------------
        ...
        //-----------------------------------
        //-----------------------------------
        int cound5 = Db.RunSQLUpdate("UPDATE account SET aboutthisblogtitle='About'");
        //-----------------------------------
        //-----------------------------------
