 ...
 */
public class Version170ToVersion171 implements UpgradeDatabaseOneVersion{
    ...
    public void doUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count = Db.RunSQLUpdate("ALTER TABLE tagimagelink CHANGE imagetagimagelinkid tagimagelinkid int(11) NOT NULL auto_increment");
        //-----------------------------------
        //-----------------------------------
