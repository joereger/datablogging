...
//        try{
//            Set childrenNames = reger.cache.jboss.Cache.getTreeCache().getChildrenNames(fqn);
...
//                try{
//                    Object objInCache = (Object)reger.cache.jboss.Cache.getTreeCache().getObject(fqnFull);
//                    if (objInCache!=null){
...
//                                out.append(brAndIndent+"Account.siterooturl: "+us.getAccount().getSiteRootUrl());
//                            }
//                            //User
//                            if (us.getAccountuser()!=null){
//                                out.append(brAndIndent+"Is Logged In? ");
//                                if (us.getAccountuser().isLoggedIn){
//                                    out.append(" YES");
...
//                        Set cNames = reger.cache.jboss.Cache.getTreeCache().getChildrenNames(fqnFull);
