 ...
 * A version
 */
public class Version23 implements Version{
    ...
    public Calendar getDeploymentDateGMT(){
        return reger.core.TimeUtils.dbstringtocalendar("2012-02-24 00:00:00");
    }

    public String getQuickSummary(){
        return "Major user interface overhaul.  Reset of user templates.  CSS/HTML5.  General simplification of the system.";
    }
