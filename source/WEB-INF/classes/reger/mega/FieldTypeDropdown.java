...
public class FieldTypeDropdown extends Field implements FieldType, ChartField{
    ...
    public String getBackEndDescription() {
        return "A standard dropdown list.";
    }
    ...
    public String getHtmlAdmin(int logid, boolean isFormActive) {
	    ...
	    outstring.append("<select name=megafieldid-"+ this.megafieldid +" "+disabledFormText+">");
        ...
        if (isFormActive){
            outstring.append("<a href='entry-fieldoptions.log?megafieldid="+ megafieldid +"&logid="+ logid +"' onclick=\"javascript:NewWindow(this.href,'name','450','0','yes');return false;\">edit choices</a>");
        }
	...
	private StringBuffer singleOptionHtml(String thisValue){
        StringBuffer outstring = new StringBuffer();
