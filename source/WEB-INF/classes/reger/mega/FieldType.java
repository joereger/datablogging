...
public interface FieldType extends FieldInterface {
     ...
     * If the user doesn't submit any search criteria, then
     * no matter what the value of the field is, return TRUE.
     */
     ...
     * The int logidOrEtid is so that on html forms with more than one log the logs
     * can be distinguished.   In most cases a logid will be used.
     */
