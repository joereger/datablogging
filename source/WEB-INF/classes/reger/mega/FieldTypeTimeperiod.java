...
//    }
    ...
    public String getHtmlAdmin(int logid, boolean isFormActive) {
        ...
        outstring.append("<input class=\"col-md-1\" style=\"width:25px;\" type=text size=2 maxlength=5 name=megafieldid-"+ megafieldid + "-hours value=\""+ hms.getHours() +"\" "+disabledFormText+">");
        outstring.append("hrs &nbsp;:&nbsp; ");
        outstring.append("<input class=\"col-md-1\" style=\"width:25px;\" type=text size=2 maxlength=5 name=megafieldid-"+ megafieldid + "-minutes value=\""+ hms.getMinutes() +"\" "+disabledFormText+">");
        outstring.append("min &nbsp;:&nbsp; ");
        outstring.append("<input class=\"col-md-1\" style=\"width:25px;\" type=text size=2 maxlength=5 name=megafieldid-"+ megafieldid + "-seconds value=\""+ hms.getSeconds() +"\" "+disabledFormText+">");
