...
import reger.core.db.DbNoErrorsave;
import reger.util.Num;
import reger.util.GeneralException;
...
public class InstanceProperties {
    ...
    public static void load(){
        ...
        //System.out.println("InstanceProperties.load() called");
        if (!haveValidConfig && !haveAttemptedToLoadDefaultPropsFile){
            try {
                ...
                try{
                    ...
                    System.out.println("Looking for internal file ("+dbPropsInternalFilename+")");
                    if (internalFile!=null && internalFile.exists() && internalFile.canRead() && internalFile.isFile()){
                        ...
                        System.out.println("Got instance props from internal file ("+dbPropsInternalFilename+")");
                    }
                } catch (IOException e) {
                    //e.printStackTrace();
                } catch (Exception e){
                ...
                if (!gotFile){
                    try{
                        ...
                        System.out.println("Looking for external file ("+dbPropsExternalFilename+")");
                        if (externalFile!=null && externalFile.exists() && externalFile.canRead() && externalFile.isFile()){
                            ...
                            System.out.println("Got instance props from external file ("+dbPropsExternalFilename+")");
                        }
                    } catch (IOException e) {
                        //e.printStackTrace();
                    } catch (Exception e){
    ...
    public static boolean haveValidConfig() {
        load();
        //System.out.println("InstanceProperties.haveValidConfig() returning "+haveValidConfig);
        return haveValidConfig;
    }
