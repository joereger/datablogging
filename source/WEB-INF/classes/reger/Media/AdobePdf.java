 ...
 */
public class AdobePdf implements MediaType {
    ...
    public void createThumbnail(String pathToFile, String pathToThumbnail) {
        try{
            reger.core.Util.copyFile(reger.core.WebAppRootDir.getWebAppRootPath() + "images\\mediatypeicons\\icon-pdf.gif", pathToThumbnail);
        } catch (Throwable e) {
            Debug.errorsave(e, "");
        }
    }
