 ...
 */
public class Html implements MediaType {
    ...
    public void createThumbnail(String pathToFile, String pathToThumbnail, int imageid) {
        try{
            reger.core.Util.copyFile(reger.core.WebAppRootDir.getWebAppRootPath() + "images\\mediatypeicons\\icon-html.gif", pathToThumbnail);
        } catch (Throwable e) {
            Debug.errorsave(e, "");
        }
    }
