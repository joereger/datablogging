 ...
 */
public class Visio implements MediaType {

    /**
     * Returns the proper mime type for this MediaType
     */
    public String getMimeType(){
        return "application/ms-visio";
    }
    ...
    public void createThumbnail(String pathToFile, String pathToThumbnail, int imageid) {
        try{
            reger.core.Util.copyFile(reger.core.WebAppRootDir.getWebAppRootPath() + "images\\mediatypeicons\\icon-visio.gif", pathToThumbnail);
        } catch (Throwable e) {
