 ...
 */
public class MsPowerpoint implements MediaType {
    ...
    public void createThumbnail(String pathToFile, String pathToThumbnail) {
        try{
            reger.core.Util.copyFile(reger.core.WebAppRootDir.getWebAppRootPath() + "images\\mediatypeicons\\icon-powerpoint.gif", pathToThumbnail);
        } catch (Throwable e) {
            Debug.errorsave(e, "");
        }
    }
