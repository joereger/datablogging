...
public class AllPlJspPages {
    ...
    private static void load(){
       ...
       //NOTE: DO NOT EVER CHANGE THE PLJSPID HERE... YOU CAN DELETE LINES, BUT NEVER CHANGE... UNLESS YOU KNOW WHAT YOU'RE DOING
        ...
        nestedNavItems.add((NestedNavItem)(new PlJspPage(-61, "Our Partners", "biz-partners.log", NestedNavItem.NESTEDNAVTYPEPLJSPPAGE, -28, 3)));
        nestedNavItems.add((NestedNavItem)(new PlJspPage(-50, "Our Technology", "biz-technology.log", NestedNavItem.NESTEDNAVTYPEPLJSPPAGE, -28, 4)));
        nestedNavItems.add((NestedNavItem)(new PlJspPage(-50, "Contact Us", "biz-contactus.log", NestedNavItem.NESTEDNAVTYPEPLJSPPAGE, -28, 5)));
        nestedNavItems.add((NestedNavItem)(new PlJspPage(-51, "Press", "biz-pr-overview.log", NestedNavItem.NESTEDNAVTYPEPLJSPPAGE, -28, 6)));
        nestedNavItems.add((NestedNavItem)(new PlJspPage(-52, "Investors", "biz-investors.log", NestedNavItem.NESTEDNAVTYPEPLJSPPAGE, -28, 7)));
